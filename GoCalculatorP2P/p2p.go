...
func ParseJSON(data []byte, strct interface{}) error{
	return json.Unmarshal(data, &strct)
}
...
func main() {
	...
	// Conversion de dolares a moneda seleccionada
	var mntCvs float64 = exg * mnt

	// Porsentaje total de las Comisiones
